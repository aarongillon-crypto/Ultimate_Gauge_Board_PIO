...
/* Widget trim: this firmware creates only lv_obj, lv_label and lv_line
 * (verified by grep across src/ and lib/). Everything else is disabled to
 * save flash. Re-enable individually if a new page needs one. */
